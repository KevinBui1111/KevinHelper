...
namespace KevinHelper
{
    class Crc32 : HashAlgorithm
    {
        ...
        #region Override abstract method from HashAlgorithm class.
    ...
    class HashCalculator
    {
        ...
        private string HashFile(string szFilename)
        {
            ...
            using (FileStream file = File.OpenRead(szFilename))
            {
                ...
                do
                {
                    nCount = file.Read(buffer, 0, MAX_BUFFER_SIZE);
            ...
            return BytesToStr(hashAlg.Hash);
        }
